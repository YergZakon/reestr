 ...
 * активность ревьюеров и журнал подач НПА.
 *
 * Агрегация по КОРНЕВОМУ органу: комитеты сворачиваются к своему министерству,
...
export async function GET() {
  ...
  // Подачи: разделяем поданные пользователями и созданные системой
  // (закрытие пробелов правового мониторинга — submitted_by IS NULL).
  ...
  return NextResponse.json({ kpi, users, subs, byOrg, reviewers, submissions, submitters });
}
